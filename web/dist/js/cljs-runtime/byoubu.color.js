...
var h__$1 = (function (){var G__22553 = h;
if(clojure.string.starts_with_QMARK_(h,"#")){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__22553,(1));
} else {
return G__22553;
}
})();
 ...
 */
byoubu.color.rgb__GT_hex = (function byoubu$color$rgb__GT_hex(p__22554){
var vec__22555 = p__22554;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(2),null);
...
var vec__22558 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22558,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22558,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22558,(2),null);
...
var pairs = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__22563){
var vec__22564 = p__22563;
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22564,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22564,(1),null);
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
...
if((total > (0))){
return byoubu.color.rgb__GT_hex((function (){var iter__5480__auto__ = (function byoubu$color$mix_$_iter__22568(s__22569){
return (new cljs.core.LazySeq(null,(function (){
var s__22569__$1 = s__22569;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22569__$1);
if(temp__5825__auto__){
var s__22569__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22569__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22569__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22571 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22570 = (0);
while(true){
if((i__22570 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__22570);
cljs.core.chunk_append(b__22571,(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__22570,i,c__5478__auto__,size__5479__auto__,b__22571,s__22569__$2,temp__5825__auto__,pairs,total){
return (function (p__22577){
var vec__22578 = p__22577;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22578,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22578,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i__22570,i,c__5478__auto__,size__5479__auto__,b__22571,s__22569__$2,temp__5825__auto__,pairs,total))
,pairs)) / total));

var G__22652 = (i__22570 + (1));
i__22570 = G__22652;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22571),byoubu$color$mix_$_iter__22568(cljs.core.chunk_rest(s__22569__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22571),null);
}
} else {
var i = cljs.core.first(s__22569__$2);
return cljs.core.cons((cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,0.0,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i,s__22569__$2,temp__5825__auto__,pairs,total){
return (function (p__22581){
var vec__22582 = p__22581;
var rgb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22582,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22582,(1),null);
return (w * cljs.core.nth.cljs$core$IFn$_invoke$arity$2(rgb,i));
});})(i,s__22569__$2,temp__5825__auto__,pairs,total))
,pairs)) / total),byoubu$color$mix_$_iter__22568(cljs.core.rest(s__22569__$2)));
}
} else {
return null;
}
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22593 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22593,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22593,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22593,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22601 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22601,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22601,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22601,(2),null);
var r__$1 = (r / 255.0);
var g__$1 = (g / 255.0);
var b__$1 = (b / 255.0);
var mx = (function (){var x__5087__auto__ = (function (){var x__5087__auto__ = r__$1;
...
var temp__5825__auto__ = byoubu.color.hex__GT_rgb(hex);
if(cljs.core.truth_(temp__5825__auto__)){
var vec__22614 = temp__5825__auto__;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22614,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22614,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22614,(2),null);
