...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22754){
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22758){
var vec__22759 = p__22758;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22759,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22759,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22762){
var vec__22763 = p__22762;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22763,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22763,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__22901(s__22902){
return (new cljs.core.LazySeq(null,(function (){
var s__22902__$1 = s__22902;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22902__$1);
if(temp__5825__auto__){
var s__22902__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22902__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22902__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22904 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22903 = (0);
while(true){
if((i__22903 < size__5479__auto__)){
var vec__22918 = cljs.core._nth(c__5478__auto__,i__22903);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22918,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22918,(1),null);
cljs.core.chunk_append(b__22904,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__23109 = (i__22903 + (1));
i__22903 = G__23109;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22904),shitsuke$hig$pair__GT_css_$_iter__22901(cljs.core.chunk_rest(s__22902__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22904),null);
}
} else {
var vec__22921 = cljs.core.first(s__22902__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22921,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22921,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__22901(cljs.core.rest(s__22902__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__22968(s__22969){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22973 = cljs.core._nth(c__5478__auto__,i__22970);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22973,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22973,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__22971,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__22970,s__22969__$1,vec__22973,group,m,c__5478__auto__,size__5479__auto__,b__22971,s__22969__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__22968_$_iter__22976(s__22977){
return (new cljs.core.LazySeq(null,((function (i__22970,s__22969__$1,vec__22973,group,m,c__5478__auto__,size__5479__auto__,b__22971,s__22969__$2,temp__5825__auto__){
return (function (){
var s__22977__$1 = s__22977;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22977__$1);
if(temp__5825__auto____$1){
var s__22977__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22977__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__22977__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__22979 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__22978 = (0);
while(true){
if((i__22978 < size__5479__auto____$1)){
var vec__22980 = cljs.core._nth(c__5478__auto____$1,i__22978);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22979,shitsuke.hig.pair__GT_css(group,k,v));

var G__23133 = (i__22978 + (1));
i__22978 = G__23133;
continue;
} else {
var G__23135 = (i__22978 + (1));
i__22978 = G__23135;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22979),shitsuke$hig$tokens__GT_css_lines_$_iter__22968_$_iter__22976(cljs.core.chunk_rest(s__22977__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22979),null);
}
} else {
var vec__22983 = cljs.core.first(s__22977__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__22968_$_iter__22976(cljs.core.rest(s__22977__$2)));
} else {
var G__23138 = cljs.core.rest(s__22977__$2);
s__22977__$1 = G__23138;
continue;
}
}
} else {
...
});})(i__22970,s__22969__$1,vec__22973,group,m,c__5478__auto__,size__5479__auto__,b__22971,s__22969__$2,temp__5825__auto__))
,null,null));
});})(i__22970,s__22969__$1,vec__22973,group,m,c__5478__auto__,size__5479__auto__,b__22971,s__22969__$2,temp__5825__auto__))
;
...
var G__23146 = (i__22970 + (1));
i__22970 = G__23146;
continue;
} else {
var G__23147 = (i__22970 + (1));
i__22970 = G__23147;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22971),shitsuke$hig$tokens__GT_css_lines_$_iter__22968(cljs.core.chunk_rest(s__22969__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22971),null);
}
} else {
var vec__22986 = cljs.core.first(s__22969__$2);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22986,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22986,(1),null);
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__22969__$1,vec__22986,group,m,s__22969__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__22968_$_iter__22989(s__22990){
return (new cljs.core.LazySeq(null,((function (s__22969__$1,vec__22986,group,m,s__22969__$2,temp__5825__auto__){
return (function (){
var s__22990__$1 = s__22990;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22990__$1);
if(temp__5825__auto____$1){
var s__22990__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22990__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22990__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22992 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22991 = (0);
while(true){
if((i__22991 < size__5479__auto__)){
var vec__22993 = cljs.core._nth(c__5478__auto__,i__22991);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22992,shitsuke.hig.pair__GT_css(group,k,v));

var G__23163 = (i__22991 + (1));
i__22991 = G__23163;
continue;
} else {
var G__23164 = (i__22991 + (1));
i__22991 = G__23164;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22992),shitsuke$hig$tokens__GT_css_lines_$_iter__22968_$_iter__22989(cljs.core.chunk_rest(s__22990__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22992),null);
}
} else {
var vec__22996 = cljs.core.first(s__22990__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__22968_$_iter__22989(cljs.core.rest(s__22990__$2)));
} else {
var G__23165 = cljs.core.rest(s__22990__$2);
s__22990__$1 = G__23165;
continue;
}
}
} else {
...
});})(s__22969__$1,vec__22986,group,m,s__22969__$2,temp__5825__auto__))
,null,null));
});})(s__22969__$1,vec__22986,group,m,s__22969__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__22968(cljs.core.rest(s__22969__$2)));
} else {
var G__23167 = cljs.core.rest(s__22969__$2);
s__22969__$1 = G__23167;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__23045(s__23046){
return (new cljs.core.LazySeq(null,(function (){
var s__23046__$1 = s__23046;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23046__$1);
if(temp__5825__auto__){
var s__23046__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23046__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23046__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23048 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23047 = (0);
while(true){
if((i__23047 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__23047);
cljs.core.chunk_append(b__23048,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__23178 = (i__23047 + (1));
i__23047 = G__23178;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23048),shitsuke$hig$iter__23045(cljs.core.chunk_rest(s__23046__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23048),null);
}
} else {
var style = cljs.core.first(s__23046__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__23045(cljs.core.rest(s__23046__$2)));
}
} else {
return null;
}
