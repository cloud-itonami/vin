...
var G__22433 = o;
reagent.impl.template.goog$module$goog$object.set(G__22433,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__22448 = o;
reagent.impl.template.goog$module$goog$object.set(G__22448,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22449 = props;
var G__22449__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22449,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22449);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22449__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22453 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22453,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22453;
}
})(),id_class);
...
var G__22454 = (cljs.core.count(argv) - first_child);
switch (G__22454) {
case (0):
...
var vec__22457 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22457,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22457,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22457,(2),null);
...
var temp__5829__auto___22507 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22507 == null)){
} else {
var key_22508 = temp__5829__auto___22507;
...
var temp__5829__auto___22509 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22509 == null)){
} else {
var key_22510 = temp__5829__auto___22509;
(jsprops.key = key_22510);
}
...
var temp__5829__auto___22532 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22532 == null)){
} else {
var key_22534 = temp__5829__auto___22532;
(jsprops.key = key_22534);
}
...
var temp__5829__auto___22546 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22546 == null)){
} else {
var key_22547 = temp__5829__auto___22546;
(jsprops.key = key_22547);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22466_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22466_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22467 = reagent.ratom.check_derefs((function (){
...
*/
reagent.impl.template.t_reagent$impl$template22473 = (function (opts,id,fn_to_element,parse_fn,meta22474){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22473.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22475,meta22474__$1){
var self__ = this;
var _22475__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22473(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22474__$1));
}));

(reagent.impl.template.t_reagent$impl$template22473.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22475){
var self__ = this;
var _22475__$1 = this;
return self__.meta22474;
}));

(reagent.impl.template.t_reagent$impl$template22473.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22473.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22473.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22473.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22473.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22473.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22474","meta22474",-52405819,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22473.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22473.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22473");

(reagent.impl.template.t_reagent$impl$template22473.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22473");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22473.
 */
reagent.impl.template.__GT_t_reagent$impl$template22473 = (function reagent$impl$template$__GT_t_reagent$impl$template22473(opts,id,fn_to_element,parse_fn,meta22474){
return (new reagent.impl.template.t_reagent$impl$template22473(opts,id,fn_to_element,parse_fn,meta22474));
});
...
return (new reagent.impl.template.t_reagent$impl$template22473(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
