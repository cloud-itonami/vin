...
return [":root { ",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",(function (){var iter__5480__auto__ = (function byoubu_ui$tokens$iter__22708(s__22709){
...
var vec__22714 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22714,(0),null);
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22714,(1),null);
var iterys__5476__auto__ = ((function (s__22709__$1,vec__22714,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function byoubu_ui$tokens$iter__22708_$_iter__22710(s__22711){
return (new cljs.core.LazySeq(null,((function (s__22709__$1,vec__22714,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__22711__$1 = s__22711;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22711__$1);
if(temp__5825__auto____$1){
var s__22711__$2 = temp__5825__auto____$1;
...
var vec__22717 = cljs.core._nth(c__5478__auto__,i__22712);
...
cljs.core.chunk_append(b__22713,[byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''));

var G__22804 = (i__22712 + (1));
i__22712 = G__22804;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22713),byoubu_ui$tokens$iter__22708_$_iter__22710(cljs.core.chunk_rest(s__22711__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22713),null);
}
} else {
var vec__22720 = cljs.core.first(s__22711__$2);
...
return cljs.core.cons([byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''),byoubu_ui$tokens$iter__22708_$_iter__22710(cljs.core.rest(s__22711__$2)));
}
} else {
return null;
}
...
});})(s__22709__$1,vec__22714,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__22709__$1,vec__22714,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
;
...
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,byoubu_ui$tokens$iter__22708(cljs.core.rest(s__22709__$1)));
} else {
var G__22854 = cljs.core.rest(s__22709__$1);
s__22709__$1 = G__22854;
continue;
}
} else {
return null;
