 ...
 */
kotoba_ui.shell.with_root_attrs = (function kotoba_ui$shell$with_root_attrs(base,p__23130){
var map__23134 = p__23130;
var map__23134__$1 = cljs.core.__destructure_map(map__23134);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23134__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__23137 = ((cljs.core.seq(attrs))?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,base], 0)):base);
var G__23137__$1 = (((!((class$ == null))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__23137,new cljs.core.Keyword(null,"class","class",-2030961996),kotoba_ui.shell.cls,kotoba_ui.shell.class_opt__GT_str(class$)):G__23137);
if((!((id == null)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23137__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__23137__$1;
}
});
...
var vec__23140 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23140,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23140,(1),null);
var map__23143 = opts;
var map__23143__$1 = cljs.core.__destructure_map(map__23143);
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23143__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23143__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23143__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var justify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23143__$1,new cljs.core.Keyword(null,"justify","justify",-722524056));
...
/** @this {Function} */
(kotoba_ui.shell.stack.cljs$lang$applyTo = (function (seq23139){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23139));
}));
...
var vec__23152 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23152,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23152,(1),null);
var map__23155 = opts;
var map__23155__$1 = cljs.core.__destructure_map(map__23155);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"title","title",636505583));
var wide = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23155__$1,new cljs.core.Keyword(null,"wide","wide",-151772487));
...
/** @this {Function} */
(kotoba_ui.shell.section.cljs$lang$applyTo = (function (seq23151){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23151));
}));
...
var map__23156 = opts;
var map__23156__$1 = cljs.core.__destructure_map(map__23156);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23156__$1,new cljs.core.Keyword(null,"title","title",636505583));
var tagline = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23156__$1,new cljs.core.Keyword(null,"tagline","tagline",281987682));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23156__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
...
var vec__23159 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23159,(0),null);
var cards = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23159,(1),null);
var map__23162 = opts;
var map__23162__$1 = cljs.core.__destructure_map(map__23162);
var min_w = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23162__$1,new cljs.core.Keyword(null,"min","min",444991522));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23162__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),kotoba_ui.shell.with_root_attrs((function (){var G__23169 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1 ? kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"grid","grid",402978600)) : kotoba_ui.shell.class_name.call(null, new cljs.core.Keyword(null,"grid","grid",402978600)))], null);
if(cljs.core.seq(style)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23169,new cljs.core.Keyword(null,"style","style",-496642736),style);
} else {
return G__23169;
}
})(),opts)], null),cards);
...
/** @this {Function} */
(kotoba_ui.shell.grid.cljs$lang$applyTo = (function (seq23157){
var self__5712__auto__ = this;
...
args__5732__auto__.push((arguments[i__5727__auto___23274]));
...
var vec__23172 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23172,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23172,(1),null);
var map__23175 = opts;
var map__23175__$1 = cljs.core.__destructure_map(map__23175);
var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23175__$1,new cljs.core.Keyword(null,"nav","nav",719540477));
var sidebar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23175__$1,new cljs.core.Keyword(null,"sidebar","sidebar",35784458));
...
/** @this {Function} */
(kotoba_ui.shell.app_shell.cljs$lang$applyTo = (function (seq23171){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23171));
}));
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23199__$1,new cljs.core.Keyword(null,"title","title",636505583));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23199__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var lang = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23199__$1,new cljs.core.Keyword(null,"lang","lang",-1819677104));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23199__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var head = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23199__$1,new cljs.core.Keyword(null,"head","head",-771383919));
...
var map__23200 = kotoba_ui.theme.theme_colors(theme);
var map__23200__$1 = cljs.core.__destructure_map(map__23200);
var light = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23200__$1,new cljs.core.Keyword(null,"light","light",1918998747));
var dark = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23200__$1,new cljs.core.Keyword(null,"dark","dark",1818973999));
...
})()], null),(cljs.core.truth_(description)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"description",new cljs.core.Keyword(null,"content","content",15833224),description], null)], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(appearance,"dark"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__23201 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"theme-color",new cljs.core.Keyword(null,"content","content",15833224),light], null);
if((appearance == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23201,new cljs.core.Keyword(null,"media","media",-1066138403),"(prefers-color-scheme: light)");
} else {
return G__23201;
}
})()], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(appearance,"light"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__23202 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"theme-color",new cljs.core.Keyword(null,"content","content",15833224),dark], null);
if((appearance == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23202,new cljs.core.Keyword(null,"media","media",-1066138403),"(prefers-color-scheme: dark)");
} else {
return G__23202;
}
...
/** @this {Function} */
(kotoba_ui.shell.page.cljs$lang$applyTo = (function (seq23191){
