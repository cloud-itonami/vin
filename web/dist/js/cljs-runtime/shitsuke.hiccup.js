...
var t = first__21873;
var body = seq__21872__$1;
var vec__21874 = (shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1 ? shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1(t) : shitsuke.hiccup.parse_tag.call(null, t));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21874,(0),null);
var base = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21874,(1),null);
var vec__21877 = ((cljs.core.map_QMARK_(cljs.core.first(body)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.rest(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body], null));
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21877,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21877,(1),null);
...
var attrs__$2 = (function (){var G__21880 = attrs__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,"textarea")){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__21880,new cljs.core.Keyword(null,"value","value",305978217));
} else {
return G__21880;
}
})();
...
var content_21920 = shitsuke.hiccup.raw_text_content(children);
shitsuke.hiccup.assert_no_rawtext_breakout_BANG_(tag,content_21920);

cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(sb,content_21920);
} else {
