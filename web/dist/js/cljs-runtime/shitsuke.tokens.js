...
var len__5726__auto___21961 = arguments.length;
var i__5727__auto___21962 = (0);
while(true){
if((i__5727__auto___21962 < len__5726__auto___21961)){
args__5732__auto__.push((arguments[i__5727__auto___21962]));

var G__21963 = (i__5727__auto___21962 + (1));
i__5727__auto___21962 = G__21963;
continue;
} else {
}
break;
...
/** @this {Function} */
(shitsuke.tokens.deep_merge.cljs$lang$applyTo = (function (seq21881){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21881));
}));
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$pair__GT_css_$_iter__21886(s__21887){
return (new cljs.core.LazySeq(null,(function (){
var s__21887__$1 = s__21887;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21887__$1);
if(temp__5825__auto__){
var s__21887__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21887__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21887__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21889 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21888 = (0);
while(true){
if((i__21888 < size__5479__auto__)){
var vec__21890 = cljs.core._nth(c__5478__auto__,i__21888);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21890,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21890,(1),null);
cljs.core.chunk_append(b__21889,["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__21977 = (i__21888 + (1));
i__21888 = G__21977;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21889),shitsuke$tokens$pair__GT_css_$_iter__21886(cljs.core.chunk_rest(s__21887__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21889),null);
}
} else {
var vec__21893 = cljs.core.first(s__21887__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21893,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21893,(1),null);
return cljs.core.cons(["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$tokens$pair__GT_css_$_iter__21886(cljs.core.rest(s__21887__$2)));
}
} else {
return null;
}
...
var vec__21907 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21907,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21907,(1),null);
var iterys__5476__auto__ = ((function (s__21901__$1,vec__21907,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function shitsuke$tokens$iter__21900_$_iter__21902(s__21903){
return (new cljs.core.LazySeq(null,((function (s__21901__$1,vec__21907,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
...
var vec__21911 = cljs.core._nth(c__5478__auto__,i__21904);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21911,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21911,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__21905,shitsuke.tokens.pair__GT_css(group,k,v));

var G__22015 = (i__21904 + (1));
i__21904 = G__22015;
continue;
} else {
var G__22016 = (i__21904 + (1));
i__21904 = G__22016;
continue;
}
} else {
...
var vec__21916 = cljs.core.first(s__21903__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21916,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21916,(1),null);
if((!((v == null)))){
...
var G__22017 = cljs.core.rest(s__21903__$2);
s__21903__$1 = G__22017;
continue;
}
}
} else {
...
});})(s__21901__$1,vec__21907,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__21901__$1,vec__21907,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
;
...
var G__22018 = cljs.core.rest(s__21901__$1);
s__21901__$1 = G__22018;
continue;
}
} else {
return null;
...
var map__21919 = deck_design;
var map__21919__$1 = cljs.core.__destructure_map(map__21919);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21919__$1,new cljs.core.Keyword("slides","theme","slides/theme",-79736158));
var text_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21919__$1,new cljs.core.Keyword("slides","text-styles","slides/text-styles",-2082623934));
...
var color_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21921){
...
var type_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21925){
var vec__21926 = p__21925;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21926,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21926,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,(function (){var G__21929 = cljs.core.PersistentArrayMap.EMPTY;
var G__21929__$1 = (cljs.core.truth_(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21929,new cljs.core.Keyword(null,"font-size","font-size",-1847940346),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts)),"px"].join('')):G__21929);
var G__21929__$2 = (cljs.core.truth_(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21929__$1,new cljs.core.Keyword(null,"color","color",1011675173),shitsuke.tokens.normalize_hex(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))):G__21929__$1);
if(cljs.core.truth_(new cljs.core.Keyword("slides","bold","slides/bold",-1297473049).cljs$core$IFn$_invoke$arity$1(ts))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21929__$2,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700));
} else {
return G__21929__$2;
}
})()], null);
})),text_styles);
var font_family = (function (){var or__5002__auto__ = (function (){var G__21930 = new cljs.core.Keyword("office-style.font","majorFont","office-style.font/majorFont",1886256746).cljs$core$IFn$_invoke$arity$1(fonts);
if((G__21930 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21930),", system-ui, sans-serif"].join('');
}
})();
...
var G__21931 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("shitsuke","colors","shitsuke/colors",-494612392),color_tokens], null);
if(cljs.core.seq(type_tokens)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21931,new cljs.core.Keyword("shitsuke","type","shitsuke/type",1602529816),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21932){
